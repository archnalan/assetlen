...
namespace assetlen.API.Controllers
{
    ...
    public class ProductDetailFeedbackController : ControllerBase
    {
        ...
        private bool IsAdmin() => User.IsInRole(UserRoles.Contractor) || User.IsInRole(UserRoles.SystemAdmin) || User.IsInRole(UserRoles.Contractor);
        ...
        /// </summary>
        [HttpPost]
        [Authorize(Roles = $"{UserRoles.Crew},{UserRoles.SystemAdmin}")]
        ...
        /// </summary>
        [HttpPut]
        [Authorize(Roles = $"{UserRoles.Contractor},{UserRoles.Contractor},{UserRoles.SystemAdmin}")]
        [ProducesResponseType(typeof(ProductDetailFeedbackDto), 200)]
        ...
        /// </summary>
        [HttpPost]
        [Authorize(Roles = $"{UserRoles.Crew},{UserRoles.Contractor},{UserRoles.SystemAdmin}")]
