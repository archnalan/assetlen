...
namespace assetlen.SqlServer.Migrations
{
    ...
    [Migration("20260817180056_P4_ProjectArrangementAndArchive")]
    partial class P4_ProjectArrangementAndArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("assetlen.Service.DataAccess.tbl_IngestBatch", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("IX_IngestBatch_ProjectId");

                    b.HasIndex("ProjectId", "SourceType")
                        .HasDatabaseName("IX_IngestBatch_Project_Source");

                    b.ToTable("tbl_IngestBatches");
                });

            modelBuilder.Entity("assetlen.Service.DataAccess.tbl_IngestedMessage", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.ToTable("tbl_IngestedMessages");
                });
            ...
            modelBuilder.Entity("assetlen.Service.DataAccess.tbl_Project", b =>
                {
                    ...
                    b.HasIndex("ArchivedAt")
                        .HasDatabaseName("IX_Project_ArchivedAt");
            ...
            modelBuilder.Entity("assetlen.Service.DataAccess.tbl_ProjectPreference", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.HasIndex("UserId", "IsPinned")
                        .HasDatabaseName("IX_ProjectPreference_User_Pinned");
            ...
            modelBuilder.Entity("assetlen.Service.DataAccess.tbl_IngestBatch", b =>
                {
                    b.HasOne("assetlen.Service.DataAccess.tbl_Artifact", "ArchiveArtifact")
                        .WithMany()
                        .HasForeignKey("ArchiveArtifactId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("assetlen.Shared.Models.Models.AppUser", "ImportedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("assetlen.Service.DataAccess.tbl_IngestedMessage", b =>
                {
                    ...
                    b.HasOne("assetlen.Service.DataAccess.tbl_ProjectMember", "AuthorMember")
                        .WithMany()
                        .HasForeignKey("AuthorMemberId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("assetlen.Service.DataAccess.tbl_IngestBatch", "Batch")
                        .WithMany()
