...
namespace mowt.API.Controllers
{
    ...
    public class ProductDetailFeedbackController : ControllerBase
    {
        ...
        private bool IsAdmin() => User.IsInRole(UserRoles.ProductConfig) || User.IsInRole(UserRoles.mowtSuperAdmin) || User.IsInRole(UserRoles.FeedbackApproval);
        ...
        /// </summary>
        [HttpPost]
        [Authorize(Roles = $"{UserRoles.CreateCommentsAndFeedback},{UserRoles.mowtSuperAdmin}")]
        ...
        /// </summary>
        [HttpPut]
        [Authorize(Roles = $"{UserRoles.FeedbackApproval},{UserRoles.ProductConfig},{UserRoles.mowtSuperAdmin}")]
        [ProducesResponseType(typeof(ProductDetailFeedbackDto), 200)]
        ...
        /// </summary>
        [HttpPost]
        [Authorize(Roles = $"{UserRoles.CreateCommentsAndFeedback},{UserRoles.FeedbackApproval},{UserRoles.mowtSuperAdmin}")]
