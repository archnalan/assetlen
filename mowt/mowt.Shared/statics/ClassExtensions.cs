...
namespace mowt.Shared.statics
{
    public static class ClassExtensions
    {
        ...
        {
            int defDecimalPlaces = int.TryParse(mowt.Shared.Models.statics.statics.allSettings[
                (int)mowt.Shared.Models.statics.statics.Configurations.NoOfDecimalPlaces], out var decPlaces)
                ? decPlaces
