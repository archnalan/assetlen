    ...
    public class GlobalContext
    {
        ...
        public async Task UpdateConfigSettings()
        {
            ...
            if (configs != null && configs.Content != null)
            {
                ...
                mowt.Shared.Models.statics.statics.allSettings = settings;
                CompanyName = settings.GetValueOrDefault((int)mowt.Shared.Models.statics.statics.Configurations.MyShopNameString, string.Empty);
                CompanyLocation = settings.GetValueOrDefault((int)mowt.Shared.Models.statics.statics.Configurations.MyShopAddressLine, string.Empty);
                CompanyPhone = settings.GetValueOrDefault((int)mowt.Shared.Models.statics.statics.Configurations.MyShopTelContact, string.Empty);
            }
        }
    }
}
